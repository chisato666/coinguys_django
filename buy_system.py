...
df1 = yf.Ticker('BTC-USD').history(period='1d',interval='5m',start="2023-01-10", end="2023-01-26")[map(str.title, ['open', 'close', 'low', 'high', 'volume'])]
...
print(tog)
csvfile=open('buy_10d.csv', 'w', newline='')
candlestick_writer= csv.writer(csvfile, delimiter=',')
tog.to_csv('buy_10d.csv')